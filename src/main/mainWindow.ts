...
async function clearData(win: BrowserWindow) {
    const { response } = await dialog.showMessageBox(win, {
        message: "Are you sure you want to reset Milcord?",
        detail: "This will log you out, clear caches and reset all your settings!\n\nMilcord will automatically restart after this operation.",
        buttons: ["Yes", "No"],
...
function initMenuBar(win: BrowserWindow) {
    ...
    const subMenu = [
        ...
        {
            label: "Force Update Milcord",
            async click() {
                await downloadVencordFiles();
                app.relaunch();
                app.quit();
            },
            toolTip: "Milcord will automatically restart after this operation"
        },
        {
            label: "Reset Milcord",
            async click() {
